...
<table class="table_form">
	<tr>
		...
		<td colspan="3"><input type="text" id="" value="11：50准时下去吃饭啊" /></td>
	</tr>
	<tr>
		<td class="td_title">消息内容</td>
		<td colspan="3"><textarea rows="3" cols="100">11：50准时下去吃饭啊</textarea></td>
	</tr>
	<tr>
		<td class="td_title">消息备注</td>
		<td colspan="3"><textarea rows="3" cols="100">哈哈，我们很准时</textarea></td>
	</tr>
	<tr>
		...
		<td>
			...
			pa_ui_datepicker_button="f_trigger_b" value="2010-7-1"
		...
		<td>
			...
			pa_ui_name="datepicker" class="datepicker" readonly="readonly"
			pa_ui_datepicker_ifformat="%Y-%m-%d"
			pa_ui_datepicker_button="f_trigger_b2" value="2011-7-1"
			pa_ui_datepicker_singleclick="true" pa_ui_datepicker_step="1" /> <img
